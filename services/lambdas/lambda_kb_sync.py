...
def lambda_handler(event, context):
    ...
    if check_knowledge_base_exists(bedrock_agent_client=bedrock_agent_client, knowledge_base_name_or_id=KB_ID) and check_data_source_exists(bedrock_agent_client=bedrock_agent_client, data_source_name_or_id=KB_DATASOURCE_ID):
